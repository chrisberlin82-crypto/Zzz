...
router.get('/addon-status', authenticateToken, subscriptionController.getAddonStatus);
router.post('/addon-trial', authenticateToken, subscriptionController.startAddonTrial);
